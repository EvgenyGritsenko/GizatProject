...
Question questions[] = {
	...
	{"Можно ли перегружать функции в C++ с одинаковыми именами, но разными параметрами?", true},
	{"Может ли функция в C++ возвращать одновременно несколько значений?", false},
	{"Может ли функция быть вызвана внутри другой функции в C++?", true},
	{"Функция в C++ всегда обязана иметь возвращаемое значение.", false},
	{"Можно ли объявить функцию внутри другой функции в C++?", false},
};
